  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e2d7571b-4456-40ca-ab0f-f7eb83f38518",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "3945cce0-9dad-4e85-9331-40ae413f3a43",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "ac49c6b8-7cf1-485e-8ac8-3d9bfb2f7227",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "b27d9b74-f5a0-46c0-943c-1644d8587af1",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "207d5d9a-8112-40be-87df-a584ba691100",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "6099ef39-2278-43c2-aec1-347ad5dc52b1",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "45e62f6b-e45c-44e8-8cad-ce5a0d9d14cf",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "4bc296d6-ea60-44ba-97e4-4a774004f7cb",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "6c783268-c9ea-4a38-9f54-c79bf28fd26f",
          "type": "basic.constant",
          "data": {
            "name": "M",
            "value": "200_000",
        ...
        {
          "id": "41027855-cf8e-49a5-9ddd-abc2b72ded4e",
          "type": "basic.constant",
          "data": {
            "name": "M",
            "value": "80_000_000",
        ...
        {
          "id": "fc8d8c73-4619-48e3-89da-99b476ddd2df",
          "type": "basic.constant",
          "data": {
            "name": "M",
            "value": "8_000_000",
        ...
        {
          "id": "5204c04a-daec-429a-9528-3ef1ada3aebb",
        ...
        {
          "id": "76675b99-89f0-4238-a9f0-85223e01ad0a",
        ...
        {
          "id": "5d830ea8-8c87-4ecb-b1c5-61449333610d",
          "type": "2003b13bb2377838f907d1482a4874d749551912",
          "position": {
            "x": -464,
            "y": 64
        ...
        {
          "id": "ee4ebe30-3bd0-499e-8a25-64dda9ac60c7",
          "type": "2003b13bb2377838f907d1482a4874d749551912",
          "position": {
            "x": -768,
            "y": -264
        ...
        {
          "id": "d4442922-1868-47cc-9351-cb0981979893",
        ...
        {
          "id": "a9407aab-52c5-402f-807e-150d5f09e101",
          "type": "basic.code",
          "data": {
            "code": "reg value;\n\nalways @(posedge clk)\n  value <= value + 1;\n",
            "params": [],
        ...
        {
          "id": "afd2aa13-1f1c-4110-aafc-0a5a8f8bf200",
        ...
        {
          "id": "ad0ec000-025c-4474-9a33-3fef3c771df5",
          "type": "basic.info",
          "data": {
            "info": "The home's values trims the servo positions",
            "readonly": false
          },
          "position": {
            "x": 624,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "5204c04a-daec-429a-9528-3ef1ada3aebb",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "3945cce0-9dad-4e85-9331-40ae413f3a43",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "b27d9b74-f5a0-46c0-943c-1644d8587af1",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "6099ef39-2278-43c2-aec1-347ad5dc52b1",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "4bc296d6-ea60-44ba-97e4-4a774004f7cb",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "76675b99-89f0-4238-a9f0-85223e01ad0a",
        ...
        {
          "source": {
            "block": "fc8d8c73-4619-48e3-89da-99b476ddd2df",
            "port": "constant-out"
          },
          "target": {
            "block": "76675b99-89f0-4238-a9f0-85223e01ad0a",
        ...
        {
          "source": {
            "block": "5d830ea8-8c87-4ecb-b1c5-61449333610d",
            "port": "645cdf4c-003a-435d-a012-f4e6ba236a12"
          },
          "target": {
            "block": "aab458e1-1533-44b0-bcc0-4cbc469ed899",
        ...
        {
          "source": {
            "block": "41027855-cf8e-49a5-9ddd-abc2b72ded4e",
            "port": "constant-out"
          },
          "target": {
            "block": "5d830ea8-8c87-4ecb-b1c5-61449333610d",
        ...
        {
          "source": {
            "block": "6c783268-c9ea-4a38-9f54-c79bf28fd26f",
            "port": "constant-out"
          },
          "target": {
            "block": "ee4ebe30-3bd0-499e-8a25-64dda9ac60c7",
            "port": "500f0897-3707-496d-aa9e-5e2544d140e7"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "d4442922-1868-47cc-9351-cb0981979893",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "e2d7571b-4456-40ca-ab0f-f7eb83f38518",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "ac49c6b8-7cf1-485e-8ac8-3d9bfb2f7227",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "207d5d9a-8112-40be-87df-a584ba691100",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "45e62f6b-e45c-44e8-8cad-ce5a0d9d14cf",
            "port": "in"
          },
          "vertices": []
        },
        ...
        },
        {
          ...
          "target": {
            "block": "a9407aab-52c5-402f-807e-150d5f09e101",
            "port": "clk"
          },
          "vertices": []
        },
