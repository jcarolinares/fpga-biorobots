...
The high level part of the Hexapod robot. Controls the high level task like path planning or computer vision
...
def basic_behaviour():
    ...
    while(True):
        ...
        for i in range(len(hz_list)):
            ...
            hexapod_pns=HexapodPNS("./circuits/basic_behaviour","./templates/hexapod_basic_behaviour.em",hz_list[i],"basic_behaviour.v")
