...
rom_values_dec255=[]
rom_values_hex=[]
for i in range(rom_size):#ESTE FOR ESTÁ MAL PLANTEADO EN SU ALGORITMO
    rom_values.append(min+i*ratio)
...
print("{:>3} {:>3} {:>3}".format("DEGREES","0-255","HEX"))
for value in range(rom_size):
    ...
    print(' {:>3}    {:>3}   {:>3}'.format(str(rom_values[value]),str(rom_values_dec255[value]),str(rom_values_hex[value])))
