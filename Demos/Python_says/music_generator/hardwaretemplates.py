...
def generate_sec_notes(template_path,output_file="secnotes.v",octave=4,duration=500):

    #keywords that changes the template
    if octave<10:
        keywords={"octave":octave,"next_octave":octave+1,"duration":duration}
    else:
        keywords={"octave":octave,"next_octave":octave,"duration":duration}
